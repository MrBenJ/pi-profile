...
- [ ] Configure a currently missing removable/network path as `defaultCwd`; confirm configuration succeeds but launch reports the missing directory until it becomes available.
